...
export default function TableHeadCustom({
  ...
  const backgroundColorTableCell = theme.palette.grey[300];
  return (
    <TableHead sx={sx}>
      <TableRow>
        {onSelectAllRows && (
          <TableCell padding="checkbox" sx={{ backgroundColor: backgroundColorTableCell }}>
            <Checkbox
        ...
        {headLabel.map((headCell) => (
          <TableCell
            ...
            sx={{
              ...
              backgroundColor: backgroundColorTableCell,
            }}
          >
            {onSort ? (
              <TableSortLabel
